...
SECRET_KEY = 'django-insecure-z-g02%4k$1$9(m+v37%7jqqx8o&n@prl7sc-^9+ogq+19)^v&a'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'gmail_clone_db',
        'USER': 'root',
        'PASSWORD': 'Zaid@121',  # Replace with your MySQL password
        'HOST': 'localhost',
        'PORT': '3306',
    }
}
...
LOGIN_REDIRECT_URL = '/'  # Or '/inbox/' if you want to go directly to the inbox after login
